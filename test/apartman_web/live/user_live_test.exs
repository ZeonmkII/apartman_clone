defmodule ApartmanWeb.UserLiveTest do
  ...
  @create_attrs %{bActive: true, email: "some email", firstname: "some firstname", lastname: "some lastname", line: "some line", password: "some password", passwordConfirmation: "some passwordConfirmation", passwordHash: "some passwordHash", phone: "some phone", role: "some role", username: "some username"}
