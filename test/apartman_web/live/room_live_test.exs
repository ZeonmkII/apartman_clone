defmodule ApartmanWeb.RoomLiveTest do
  ...
  @create_attrs %{bBooked: true, bOccupied: true, number: "some number"}
  ...
  defp fixture(:room) do
    {:ok, room} = Facility.create_room(@create_attrs)
    room
  end
